  ...
  Future loadData() async {
    ...
    Future.delayed(const Duration(milliseconds: 100), () async {
        ...
        Future.delayed(const Duration(seconds: 1), () {
          Routes.router.navigateTo(locator<NavigationService>().context(), Routes.secondSplash,replace: true);
          ...
          body: Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/images/splash_one.jpg'), // Path to your image
